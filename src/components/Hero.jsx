            ...
            <div className="camp-content">
              ...
              <div className="camp-details">
                <div className="camp-info-box">
                  ...
                  <p><strong><i className="fa-regular fa-clock"></i> সময়:</strong> [এখানে সময় দিন]</p>
                ...
                <ul className="camp-service-list">
                  <li>১. প্রেসার, সুগার পরীক্ষা</li>
                  <li>২. হার্ট চেকআপ (ই সি জি)</li>
                  <li>৩. হাঁড়ের ক্ষয়ের পরীক্ষা (বোন স্ক্যান)</li>
                  <li>৪. শ্বাসকষ্টের/ ফুসফুসের পরীক্ষা (PFT)</li>
                  <li>৫. নার্ভের সমস্যায় নিউরো ডিটেকশন টেস্ট</li>
                  <li>৬. মাইগ্রেনের সমস্যায়- বিট মাইগ্রেন টেস্ট</li>
                  <li>৭. যেকোনো ব্যথার সমস্যায়- ফিজিওথেরপি ও ব্যায়াম শেখানো</li>
                  <li>৮. দাঁতের চিকিৎসা (ডেন্টাল চেকআপ)</li>
                  <li>৯. রক্ত পরীক্ষা- হিমোগ্লোবিন, কোলেস্টেরল , ভিটামিন-ডি এলার্জি টেস্ট (IgE), HbA1C</li>
                </ul>
                <div className="camp-actions">
                  <a href="https://forms.gle/sy3jJKudiX8AkxBN6" target="_blank" rel="noopener noreferrer" className="secondary-btn">
                    <i className="fa-solid fa-clipboard-list"></i> Register Now
                  </a>
                </div>
              </div>
            </div>
